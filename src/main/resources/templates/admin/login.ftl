...
<body>
    <div class="body-box">
        ...
        <div class="admin-msg-box">
            ...
            <!-- 登录信息 -->
            <form action="${base}/login/adminCheck" method="post">
	            <div class="msg-content">
	                <div class="msg-content-item">
	                    ...
	                    <input id="adminName" name="adminName" placeholder="请输入账号" type="text">
	                </div>
	                <!-- 分割线 -->
	                ...
	                <div class="hover-line"></div>
	                <button type="button" class="submit-btn" onclick="jump()">切换登录身份</button>
	                <div class="hover-line"></div>
	                <button type="submit" class="submit-btn" onclick="admin_submit()">管理员登录</button>
	                <div class="hover-line"></div>
...
/*     	    $.ajax({
    ...
    function jump(){
   	 window.location.href="${base}/login/toStuLogin";
   }
</script>
</html>