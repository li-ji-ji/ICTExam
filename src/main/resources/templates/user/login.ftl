...
<body>
    <div class="body-box">
        ...
        <div class="admin-msg-box">
            ...
            <!-- 登录信息 -->
            <form action="${base}/login/userCheck" method="post">
	            <div class="msg-content">
	                <div class="msg-content-item">
	                    ...
	                    <input id="stuId" name="stuId" placeholder="请输入账号" type="text">
	                </div>
	                <!-- 分割线 -->
	                ...
	                <div class="hover-line"></div>
	                <button type="submit" class="submit-btn" onclick="admin_submit()">用户登录</button>
	                <div class="hover-line"></div>
